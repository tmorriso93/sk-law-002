...
//   // Close the menu when a NavLink is clicked on mobile
...
//                 <ul className="flex flex-col items-center py-8 space-y-6 bg-[#1d2b4f] w-full">
//                   <li>
//                     <NavLink text="Home" path="/" onClick={handleNavLinkClick} />
//                   </li>
//                   <li>
//                     <NavLink text="About" path="/about-page" onClick={handleNavLinkClick} />
//                   </li>
//                   <li>
//                     <NavLink text="Services" path="/services-page" onClick={handleNavLinkClick} />
//                   </li>
//                   <li>
//                     <NavLink text="Contact" path="/contact-page" onClick={handleNavLinkClick} />
//                   </li>
//                 </ul>
//               </nav>
//             </div>
